...
<style>
  ...
  .serviceBox .service-icon{
      color: #fff;
      background: linear-gradient(45deg, transparent, #d53b34, transparent);
      font-size: 50px;
      line-height: 110px;
      width: 110px;
      height: 110px;
  ...
  .serviceBox .service-icon:before{
      content: '';
      background: linear-gradient(to left, #d53c33, #eb1c23);
      border-radius: 50%;
      position: absolute;
      left: 10px;
      bottom: 10px;
     ...
     <div class="row">
        <div class="col-md-12">
            <div class="business-title-left">
                <h2>Region 12 Districts/Areas</h2>
      ...
      <div class="row" style="padding: 20px 0;">
        @foreach($districts as $district)
          <div class="col-md-3 col-sm-6" style="padding: 20px 10px">
              <div class="serviceBox">
                  <div class="service-icon">
                      <span><i class="fa fa-globe"></i></span>
                  </div>
                  <a href="{{ route('district.single', $district->id) }}"><h3 class="title">{{ $district->name }}</h3></a>
                  <h6 class="addre">District Pastor</h6>
                  <p class="description">{{ $district->pastor }}</p> 
                  <h6 class="addre">Address</h6>
                  <p class="description">{{ $district->address }}</p> 
