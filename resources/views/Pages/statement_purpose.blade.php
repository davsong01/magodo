...
<span style="text-align:justify !important">
                            <img src="{{asset('images/purpose.jpg')}}" style="padding: 0px 0px 20px 20px !important; float:right !important; width:300px; text-justify:distribute" />{!!html_entity_decode($stmtpurpose->content)!!}</span>
