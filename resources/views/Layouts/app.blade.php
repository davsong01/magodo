                                ...
                                <div class="col-md-12 footer-info">
                                    <div class="row">	
                                        ...
                                        <div class="col-md-6">
                                            <div class="footer-info-right">
                                                <ul>
                                                    <li><a href="https://www.facebook.com/GOFAMINTMAGODO"> <i class="fa fa-facebook"></i> </a></li>                                       
                                                    <li><a href="https://twitter.com/gofamintmagodo"> <i class="fa fa-twitter"></i> </a></li>                                            
                                                    <li><a href="#"> <i class="fa fa-youtube"></i> </a></li>                                    
                                                    <li><a href="https://www.instagram.com/gofamintmagodo/"> <i class="fa fa-instagram"></i> </a></li>
                                                    <li><a href="http://gofamintmagodo.org.ng:2095/"> <i class="fa fa-envelope"></i> </a></li>											
                                                </ul>					
                                            </div>					
                                        </div>					
                                    </div>					
